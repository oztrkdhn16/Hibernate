...
//        session.clear();//Bunu yazmadigimiz zaman 2. sorguyu calistirmadi. Bunu yazinca asagidaki sorguyuda calistirdi
//        //cache icini sifirladik.
//
...
//        Student12 student2 = session.get(Student12.class,1L);
        ...
        //first level cache mekanizmasinda alt satirdaki kodlar icin yeni bir Query olusturur.
        Session session2 = sf.openSession();
        Transaction tx2 = session2.beginTransaction();
        System.out.println("sesion close sonrasi get islemi 1 id li ogrenci icin: ");
