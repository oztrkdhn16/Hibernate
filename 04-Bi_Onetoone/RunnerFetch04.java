...
public class RunnerFetch04 {
    ...
    public static void main(String[] args) {
        ...
        //Belirli Id'li Student'i getirelim.
        Student04 student = session.get(Student04.class,1001);

        //Belirli Id'li Diary get edelim.
...
//        // Ustteki HQL kodun SQL hali : select s.std_name, d.name from student04 s inner join diary04 d on s.id = d.std_id ;
...
//        });
        ...
        // LEFT JOIN **********************************************************************
        //Kisaca butun ogrenciler ve kitabi olan ogrencileri istiyorum.
...
//        });
        ...
        // HQL RIGHT JOIN ************************************************************
        // kisaca: Butun gunlukler ve gunlugu olan ogrenciler
//        String hqlQuery3 =
...
//        });
        ...
        // HQL FULL JOIN ************************************************************
        //Kisaca: Butun student ve diary bilgileri gelsin
        String hqlQuery4 =
